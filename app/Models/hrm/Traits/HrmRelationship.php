...
use App\Models\hrm\EmployeeHome;
use App\Models\hrm\EmployeeEmergencyContact;
...
trait HrmRelationship
{
    ...
    {
        return $this->hasOne(EmployeeHome::class, 'user_id');
    }
    ...
    {
        return $this->hasOne(Hrm::class, 'created_by');
    }
